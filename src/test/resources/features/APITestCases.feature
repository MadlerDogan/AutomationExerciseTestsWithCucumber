Feature: API TESTS
  ...
  @API_TC12
  Scenario Outline: TC11 DELETE METHOD To Delete User Account
    Given Delete Request parameters : "<email>", "<password>"
    Then Verify Response Code: "<response_code>", Response Message as "<response_message>"

    Examples:
      | email          | password       | response_code | response_message |
      | arif@marif.com | arif@marif.com | 200           | Account deleted! |
